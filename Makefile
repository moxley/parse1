...
all: bin/print_tree bin/print_exprs bin/print_tokens bin/escape_string bin/list_errors bin/execute bin/test_list bin/test_icode bin/format_value bin/test_execstmt bin/test_exec
