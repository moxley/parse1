...
bin/print_tree: src/print_tree.c lib/filebuf.o lib/scanner.o lib/parser.o lib/util.o
	cc $(CFLAGS) -o bin/print_tree src/print_tree.c lib/filebuf.o lib/scanner.o lib/parser.o lib/util.o
...
bin/print_lines: src/print_lines.c lib/filebuf.o lib/scanner.o lib/util.o
	cc $(CFLAGS) -o bin/print_lines src/print_lines.c lib/filebuf.o lib/scanner.o lib/util.o

bin/print_chars: src/print_chars.c lib/filebuf.o lib/scanner.o lib/util.o
	cc $(CFLAGS) -o bin/print_chars src/print_chars.c lib/filebuf.o lib/scanner.o lib/util.o
