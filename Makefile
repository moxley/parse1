...
bin/run: src/main.c lib/exec.o lib/scanner.o lib/parser.o lib/util.o
	cc $(CFLAGS) -o bin/run src/main.c lib/exec.o lib/scanner.o lib/parser.o lib/util.o
...
lib/parser.o: src/parser.c include/parser.h lib/util.o
	cc $(CFLAGS) -c -o lib/parser.o lib/util.o src/parser.c
