...
bin/run: src/main.c $(EXEC_LIBS)
	cc $(CFLAGS) -o bin/run src/main.c $(EXEC_LIBS)

bin/test_exec: src/test_exec.c $(EXEC_LIBS)
	cc $(CFLAGS) -o bin/test_exec src/test_exec.c $(EXEC_LIBS)
...
bin/test_to_s: src/test_to_s.c $(PARSER_LIBS)
	cc $(CFLAGS) -o bin/test_to_s src/test_to_s.c $(PARSER_LIBS)

bin/format_value: src/format_value.c $(PARSER_LIBS)
	cc $(CFLAGS) -o bin/format_value src/format_value.c $(PARSER_LIBS)
...
bin/test_icode: src/test_icode.c $(PARSER_LIBS)
	cc $(CFLAGS) -o bin/test_icode src/test_icode.c $(PARSER_LIBS)

bin/list_errors: src/list_errors.c $(PARSER_LIBS)
	cc $(CFLAGS) -o bin/list_errors src/list_errors.c $(PARSER_LIBS)

bin/print_tokens: src/print_tokens.c $(SCANNER_LIBS)
	cc $(CFLAGS) -o bin/print_tokens src/print_tokens.c $(SCANNER_LIBS)

bin/escape_string: src/escape_string.c $(SCANNER_LIBS)
	cc $(CFLAGS) -o bin/escape_string src/escape_string.c $(SCANNER_LIBS)
